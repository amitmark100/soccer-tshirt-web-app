 ...
 * /api/auth/login:
 *   post:
 *     summary: Log in a user with credentials
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 * /api/auth/google:
 *   post:
 *     summary: Sign in or create a user with Google OAuth
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     responses:
 *       200:
 *         description: Successfully signed in or created user with Google
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/AuthResponse'
 ...
 *   put:
 *     summary: Update user profile (username and/or profile picture)
 *     tags: [Auth]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *                 type: string
 *                 format: binary
 *                 description: New profile picture file (optional)
 *     responses:
 *       200:
 ...
 * /api/auth/refresh:
 *   post:
 *     summary: Refresh access and refresh tokens using refresh token
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
